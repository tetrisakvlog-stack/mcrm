...
const THEME_KEY = "mcrm_theme"; // "light" | "dark" | "system"
...
function ThemeSelect({ theme, setTheme, className = "" }) {
  return (
    <div className={"flex items-center gap-2 " + className}>
      <Label className="text-xs hidden sm:block text-zinc-600 dark:text-slate-300">Téma</Label>
      <select
...
export default function App() {
  ...
  if (!session?.user?.id || !profile) {
    return (
      <div className={appShell + " p-4 md:p-8"}>
        <div className="flex justify-end mb-4">
          <ThemeSelect theme={theme} setTheme={setTheme} />
        </div>
          ...
          <Card>
            ...
            <CardContent className="space-y-4">
              <div className="flex gap-2">
                ...
                <Button variant={authMode === "register" ? "primary" : "outline"} className="w-full" onClick={() => setAuthMode("register")}>
                  Registrovať
                </Button>
              </div>
  ...
  return (
    <div className={appShell}>
      <div className="sticky top-0 z-10 border-b border-zinc-200 bg-white/80 backdrop-blur dark:border-slate-800 dark:bg-slate-950/50">
        <div className="mx-auto max-w-6xl px-4 py-3 flex items-center justify-between gap-3">
          ...
          <div className="flex items-center gap-2">
            <ThemeSelect theme={theme} setTheme={setTheme} className="hidden sm:flex" />
    ...
    <Tabs value={tab} onValueChange={setTab}>
      ...
      <TabsContent value="admin" className="mt-4">
        {isAdmin ? (
          ...
          <Card>
            <CardContent className="p-4 text-sm text-zinc-600 dark:text-slate-300">Nemáš admin oprávnenie.</CardContent>
          </Card>
        )}
      </TabsContent>
        ...
        <CardContent className="pt-2 space-y-4">
          <div className="grid gap-3 sm:grid-cols-3">
            <div className="space-y-2">
              ...
              <select
                className="w-full h-10 rounded-xl border border-zinc-300 bg-white px-3 text-sm text-zinc-900
                           dark:border-slate-700 dark:bg-slate-900/50 dark:text-slate-100"
            ...
            <div className="space-y-2">
              ...
              <div className="h-10 rounded-xl border border-zinc-300 px-3 flex items-center justify-between dark:border-slate-700 dark:bg-slate-900/30">
    ...
    <div className="space-y-4">
      <Card>
        ...
        <CardContent className="pt-2 space-y-4">
          ...
          <Dialog open={dialogOpen} onOpenChange={setDialogOpen} title={form.id ? "Upraviť kontakt" : "Nový kontakt"}>
            <div className="grid gap-3">
              ...
              <div className="grid gap-2">
                ...
                <textarea
                  className="min-h-[90px] rounded-xl border border-zinc-300 bg-white px-3 py-2 text-sm text-zinc-900 outline-none
  ...
  return (
    <div className="space-y-4">
              ...
              <TBody>
                {profiles.map((u) => (
                  <Tr key={u.id}>
                    ...
                    <Td>
                      <select
                        className="h-9 rounded-xl border border-zinc-300 bg-white px-2 text-sm text-zinc-900
                                   dark:border-slate-700 dark:bg-slate-900/50 dark:text-slate-100"
                        value={u.role}
      ...
      <Card>
        ...
        <CardContent className="pt-2 space-y-3">
          <div className="flex items-center justify-between rounded-xl border border-zinc-200 p-3 dark:border-slate-800 dark:bg-slate-900/30">
            <div className="flex items-center gap-2">
