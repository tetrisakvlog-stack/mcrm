...
export function Label({ children, className = "", ...props }) {
  return (
    <label className={cx("text-sm font-medium text-zinc-800", className)} {...props}>
      {children}
    </label>
  );
}
...
export function THead({ children, className = "" }) {
  return <thead className={cx("bg-zinc-50 text-zinc-600", className)}>{children}</thead>;
}
export function TBody({ children, className = "" }) {
  return <tbody className={className}>{children}</tbody>;
}
export function Tr({ children, className = "" }) {
  return <tr className={cx("border-b border-zinc-200", className)}>{children}</tr>;
}
export function Th({ children, className = "" }) {
  return <th className={cx("px-3 py-2 text-left text-xs font-semibold uppercase tracking-wide", className)}>{children}</th>;
}
export function Td({ children, className = "", colSpan }) {
  return <td colSpan={colSpan} className={cx("px-3 py-2 align-top", className)}>{children}</td>;
}
